...
export default function AdminCategories() {
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      // First, update articles to remove the category reference
      ...
      if (updateError) {
        ...
        // Continue anyway, maybe there are no articles
      }
      ...
      if (error) {
        ...
        alert('خطأ في الحذف: ' + (error.message || 'يرجى المحاولة مرة أخرى'))
        return
      }
      fetchCategories()
    } catch (err: any) {
      console.error('Delete error:', err)
      alert('خطأ في الحذف: ' + (err.message || 'يرجى المحاولة مرة أخرى'))
    }
  }
